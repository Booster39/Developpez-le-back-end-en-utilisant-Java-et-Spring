  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    http
      ...
      .cors(cors -> cors.configurationSource(request -> {
                  ...
                  corsConfiguration.setAllowedOrigins(List.of("https://developpez-le-back-end-en-utilisant-java-et-spring-ayeytbw54.vercel.app", "https://developpez-le-back-end-en-utilisant-java-et-spring.vercel.app"));
